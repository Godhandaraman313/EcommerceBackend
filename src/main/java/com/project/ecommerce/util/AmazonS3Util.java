...
public class AmazonS3Util {
    ...
    static {
        // Typically read from environment variable or properties. Using env var for simplicity as in Shopme.
        String envBucket = System.getenv("AWS_BUCKET_NAME");
        BUCKET_NAME = envBucket != null ? envBucket : "ecommerce-demo-bucket"; 
    }
